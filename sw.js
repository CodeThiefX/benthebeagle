  ...
  (s.n = (e) => {
    ...
    (() => {
      var e = s(89),
        ...
        i = s(634);
      const c = JSON.parse(
          '["benthebeagle\\\\.vip(?:/.*)?/ola/services/.*","benthebeagle\\\\.vip/ola/meetings/.*","/api/","https://api\\\\.ola\\\\.godaddy\\\\.com","https://7037520c-904e-40ac-86ef-4c46aa70d3a9\\\\.onlinestore\\\\.godaddy\\\\.com","/t/1/tl/event","google-analytics\\\\.com/collect","calendar\\\\.apps\\\\.(dev-|test-)?secureserver\\\\.net"]'
        ).map((e) => new RegExp(e)),
        o = JSON.parse(
          '["benthebeagle\\\\.vip(?:/.*)?/f/.*","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/7037520c-904e-40ac-86ef-4c46aa70d3a9/feed/post/","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/7037520c-904e-40ac-86ef-4c46aa70d3a9/feed"]'
        ).map((e) => new RegExp(e)),
        h = JSON.parse('["/home"]').map((e) => ({
          url: e,
          revision: "1716740332368",
        }));
      self.addEventListener("activate", function (e) {
        e.waitUntil(
          caches.keys().then(function (e) {
            return Promise.all(
              e
                .filter((e) => e.startsWith("benthebeagle.vip-"))
